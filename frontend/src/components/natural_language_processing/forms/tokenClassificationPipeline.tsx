...
export const tokenClassificationPipelineFormSchema = z.object({
  user_input: z.string(),
});

export async function onTokenClassificationPipelineFormSubmit(
  data: z.infer<typeof tokenClassificationPipelineFormSchema>
) {
  try {
    const resultJson = jsonGenerator(TaskTypes.TOKEN_CLASSIFICATION, [
