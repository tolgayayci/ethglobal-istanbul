...
export const conversationalPipelineFormSchema = z.object({
  user_input: z.string(),
});

export async function onConversationalPipelineFormSubmit(
  data: z.infer<typeof conversationalPipelineFormSchema>
) {
  try {
