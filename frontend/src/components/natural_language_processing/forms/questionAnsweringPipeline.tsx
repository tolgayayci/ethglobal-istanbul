...
export const questionAnsweringPipelineFormSchema = z.object({
  user_input: z.string(),
});

export async function onQuestionAnsweringPipelineFormSubmit(
  data: z.infer<typeof questionAnsweringPipelineFormSchema>
) {
  try {
