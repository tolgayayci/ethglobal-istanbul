...
export const textGenerationPipelineFormSchema = z.object({
  user_input: z.string(),
});

export async function onTextGenerationPipelineFormSubmit(
  data: z.infer<typeof textGenerationPipelineFormSchema>
) {
  try {
    const resultJson = jsonGenerator(TaskTypes.TEXT_GENERATION, [
